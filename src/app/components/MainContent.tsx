        ...
        <main className="main-content mx-10 mt-10">
            ...
            <ul className="list-disc mx-5 mb-5">
                ...
                <div className="mb-5 flex flex-wrap justify-center items-center gap-2">
                    ...
                    <a target="_blank" href="https://metro.co.uk/2020/07/14/dr-disrespect-move-spotify-not-youtube-claims-new-theory-12985925/">
                    <Image
                        src="/metro-co-uk-logo-vector.svg"
                        width={100}
                        height={100}
                        alt={"Metro"}
                    />
                    </a>
                    <a target="_blank" href="https://www.essentiallysports.com/got-a-50-from-drdisrespect-nickmercs-gets-mysterious-donation-twitch-esports-news/">
                        <Image
                        src="/es1.png"
                        width={75}
                        height={75}
                ...
                <li>
                    In 2021, I wrote a <a className="font-bold underline" target="_blank" href="https://twitter.com/Montana_Wong/status/1472023753865396227">Twitter thread</a> that analyzed and brought attention to a smart contract software exploit perpetuated by a lone developer that allowed them to profit $600k off of Adidas's first NFT sale. The post reached over 2 million people and was covered by news outlets such as <a href="https://decrypt.co/88705/adidas-ethereum-nft-drop-nets-23-million-and-shoots-to-top-of-charts" className="font-bold underline" target="_blank" >Decrypt</a>.
                </li>
                <div className="mb-5 flex flex-wrap justify-center items-center gap-2">
                    <a target="_blank" href="https://decrypt.co/88705/adidas-ethereum-nft-drop-nets-23-million-and-shoots-to-top-of-charts">
                        <Image
                            src="/decrypt.svg"
                            width={150}
                            height={64}
                    ...
                    <a target="_blank" href="https://it.cryptonews.com/news/user-purchases-330-adidas-nfts-using-smart-contract-328-more-than-the-cap-it.htm">
                        <Image
                            src="/cryptonews.png"
                            width={100}
                            height={100}
                    ...
                    <a target="_blank" href="https://www.crypto-insiders.nl/nieuws/altcoin/adidas-ethereum-nfts-verkocht-voor-23-miljoen/">
                        <Image
                            src="/ci.png"
                            width={75}
                            height={75}
                ...
                <div className="mb-5 flex flex-wrap justify-center items-center gap-2">
                    <a target="_blank" href="https://markets.businessinsider.com/news/currencies/apedao-token-bored-ape-yacht-club-nft-sell-vote-valuation-2022-1">
                        <Image
                            src="/Business_Insider_Logo.svg"
                            width={100}
                            height={100}
                            alt={"business insider"}
                        />
                    </a>
                    <a target="_blank" href="https://www.theblockcrypto.com/post/132435/apedaos-members-are-voting-to-sell-81-bored-ape-nfts-to-reimburse-token-holders">
                        <Image
                            src="/theblock.png"
                            width={100}
                            height={100}
                    ...
                    <a target="_blank" href="https://thedefiant.io/nft-collectors-liquidation-bayc">
                        <Image
                            src="/thedefiant.png"
                            width={100}
                            height={100}
            ...
            <ul className="list-disc mx-5 mb-5">
                ...
                <li>
                    <span>
                        In September 2022, <a className="font-bold underline" target="_blank" href="https://twitter.com/fabdarice">fabdarice</a> and I launched <a href="https://nested.trade" className="font-bold underline" target="_blank">NestedTrade</a>, an open source decentralized protocol for buying and selling <a target="_blank" className="font-bold underline" href="https://www.proof.xyz/moonbirds">Moonbird NFTs</a> on Ethereum. To date the protocol has facilitated ~$800k of trading volume. The protocol code is open sourced under the GPLv3 license.
                    </span>
                </li>
                <li>
	                <span>
            ...
            <div className="mb-5">
                To get in touch, feel free to send me a dm on social media, or reach out directly <a className="font-bold underline" target="_blank" href="https://forms.gle/3JV9v297dskCpyGS7">here</a>.
            </div>
        </main>
    );
};
